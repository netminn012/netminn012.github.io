...
export interface SiteItem extends LinkItem {
  external: boolean;
  displayUrl: string;
}
...
export const mainLinks: LinkItem[] = [
  {
    name: 'Discord Server',
    description: "netminn012's server",
    url: 'https://discord.gg/grHTbCQTVr',
    icon: 'discord',
    featured: true,
  },
  ...
  {
    name: 'はてなブログ',
    description: 'Android・PC・鉄道など',
    url: 'https://netminn012.hatenablog.com/',
    icon: 'hatena',
  },
];
...
export const otherLinks: LinkItem[] = [
  {
    name: 'Discord メイン',
    description: '@netminn012',
    url: 'https://discord.com/users/1133996291349827584',
    icon: 'discord',
  },
  {
    name: 'Discord サブ',
    description: 'サブアカウント',
    url: 'https://discord.com/users/1184079519896838234',
    icon: 'discord',
  },
...
export const operatedSites: SiteItem[] = [
  {
    name: '田所浩二.jp',
    description: 'ネタ系サイト / 個人運営',
    displayUrl: '田所浩二.jp',
    url: 'https://xn--4kq239b58hryh.jp/',
    icon: 'site',
    external: true,
  },
  {
    name: 'netminn012.com',
    description: 'このリンク集サイト',
    displayUrl: 'netminn012.com',
    url: '/',
    icon: 'site',
    external: false,
  },
